                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Enregistre Un Lecteur</h3>
                    </div>
                    <div class="card-body">
                      ...
                      <form>
                        ...
                        <div class="form-group">
                          <label class="form-control-label">Nationnalite</label>
                          <input type="email" placeholder="Email Address" class="form-control">
                        </div>
                        <div class="form-group">
                          <label for="fileInput" class="form-control-label">Joindre votre piece</label>
